...
let package = Package(
  ...
  dependencies: [
    .package(url: "https://github.com/intrusive-memory/SwiftProyecto.git", .upToNextMajor(from: "4.2.0")),
    ...
    // Capped to the 0.8.x line: mlx-audio-swift 0.9.0 (the swift-tokenizers 0.6/0.7
